...
Cashflow schedules are generated by IRSModel and discounted by the DCF engine.
"""
...
schedules = IRSModel(valuation_date=VALUATION_DATE, leg_two_curve=curve).price(irs)
result = DCF(
    Instrument(cashflow_schedules=list(schedules), ir_curve=curve)
).discount_cashflows()
