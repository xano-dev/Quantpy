...
class IRCapModel(BaseModel):
    ...
    def _validate(self, ircap: IRCapFloor):
    ...
    def _compute_schedule(self, ircap: IRCapFloor):
    ...
    def _compute_payoffs(self, ircap: IRCapFloor, curve: IRCurve, fixing: float):
    ...
    def price(self, ircap: IRCapFloor) -> PeriodicCashFlowSchedule:
